...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(17613004);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetMouseButtonContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetMouseButtonContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setMouseButton(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetMaxForceContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetMaxForceContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setMaxForce(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetFrequencyContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetFrequencyContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFrequency(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetDampingContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__DraggablePhysics__DraggablePhysics.DraggablePhysics.prototype.SetDampingContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setDamping(eventsFunctionContext.getArgument("Value"));
}
}}
